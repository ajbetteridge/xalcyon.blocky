...
* TODO combine turtle and world so that draw-room and stuff are direct members of "reactor" not reactor-turtle
* TODO grammars 
* Draft of level generator system
* grammars that boil down to simple lisp functions invoking methods etc
* grammars-->worlds
