...
* TODO level builder functions accept one parameter, an integer expressing difficulty level (i.e. level 1 of the game, level 2, etc, not "easy hard medium")
* TODO onscreen event-responsive particle glitch grids, really quick transient effects with transparency
* TODO new enemy and/or new item
* TODO more themes 
* TODO radiation cloud world
* TODO investigate http://angg.twu.net/ICON/tron.icn
