...
* TODO fast moving electric death walls too!
* TODO debug wall glide
* TODO hot-gas-spewing vents
* TODO new weapon/enemy boss thing with personality
* TODO weapon is an auto-firing pod that pops out, uses energy while it fires in a circle, then comes back.
* TODO or acquire a trail
