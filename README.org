...
** TODO make menubar togglable, plus MERGE shell into world with a hotkey to switch modes
*** TODO wait, maybe not.... algebra of worlds might such with that many fields???
